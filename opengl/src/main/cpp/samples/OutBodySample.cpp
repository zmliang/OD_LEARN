...
#include "OutBodySample.h"


GLint OutBodySample::init() {
    char *pVetCode;
    ESContext::self()->readShaderSrcFromAsset("outbody/vertex",pVetCode);
    char *pFragCode;
    ESContext::self()->readShaderSrcFromAsset("outbody/fragment",pFragCode);
...
void OutBodySample::loadTexture( GLuint &textureId, const char *textureSource) {
...
GLvoid OutBodySample::draw(float greenVal) {
    // 清除颜色缓冲
...
OutBodySample::~OutBodySample() noexcept {
